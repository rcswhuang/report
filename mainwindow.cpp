...
void HReportMainWindow::initSARibbonBar()
{
    ...
    SARibbonCategory* categoryOther = m_ribbonMenuBar->addCategoryPage(QStringLiteral("打印"));
...
void HReportMainWindow::createCategoryMain(SARibbonCategory *page)
{
    ...
    btn = btnGroup->addButton(new QAction(QIcon(":/icon/icon/FontSizeDecreaseWord.png"),"",this));
    btn->setFixedWidth(35);
    fontPannel->addWidget(btnGroup,3,3);


    ////////////////////////////////////////////对齐设置/////////////////////////////////////////////////
    SARibbonPannel* alignAndborderPannel = page->addPannel(QStringLiteral("边框和对齐"));
    ...
    //设置自动换行
    //SARibbonButtonGroupWidget* wrapBtnGroup = new SARibbonButtonGroupWidget(alignAndborderPannel);
    //wrapBtnGroup->setFrameShape(QFrame::NoFrame);
    //wrapBtnGroup->addButton(new QAction(QIcon(":/icon/icon/Bold.png"),"",this));
    act = new QAction(this);
    ...
    /////////////////////////////////////////////边框设置////////////////////////////////////////////////
    SARibbonPannel* alignPannel = page->addPannel(QStringLiteral("边框和对齐"));
    act = new QAction(this);
    act->setIcon(QIcon(":/icon/icon/align-justify.png"));
    act->setText(QStringLiteral("两端对齐"));
    alignPannel->addLargeAction(act);

    act = new QAction(this);
    act->setIcon(QIcon(":/icon/icon/align-left.png"));
    act->setText(QStringLiteral("左对齐"));
    alignPannel->addSmallAction(act);

    act = new QAction(this);
    act->setIcon(QIcon(":/icon/icon/align-center.png"));
    act->setText(QStringLiteral("居中对其"));
    alignPannel->addSmallAction(act);

    act = new QAction(this);
    act->setIcon(QIcon(":/icon/icon/align-right.png"));
    act->setText(QStringLiteral("右对齐"));
    alignPannel->addSmallAction(act);
